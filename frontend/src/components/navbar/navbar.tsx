...
export const Navbar = async () => {
  ...
  return (
    <div className="bg-background fixed bottom-0 z-10 flex w-full justify-center border-t md:h-screen md:w-fit md:flex-col md:items-center md:justify-start md:border-r md:border-t-0 md:py-8 xl:w-full xl:max-w-xs xl:items-start">
